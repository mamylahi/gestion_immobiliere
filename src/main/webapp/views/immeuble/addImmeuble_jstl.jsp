        ...
        <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 rounded-3xl text-white p-8 shadow-xl relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        <div class="flex items-center mb-4">
                            ...
                            <div>
                                <h1 class="text-3xl font-bold">Ajouter un Immeuble</h1>
                                <p class="text-white text-opacity-90">Ajoutez une nouvelle propriété à votre portefeuille</p>
                            </div>
                        </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                <div class="bg-gradient-to-r from-gray-50 to-blue-50 px-8 py-6 border-b border-gray-200">
                    ...
                    <p class="text-gray-600 text-sm mt-1">Remplissez tous les champs pour créer votre immeuble</p>
                </div>

                <form action="immeuble" method="post" enctype="multipart/form-data" class="p-8">
                        ...
                        <div class="space-y-6">
                            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="adresse" name="adresse" required
                                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                           placeholder="Ex: 123 Avenue Léopold Sédar Senghor, Dakar">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" id="nombreUnite" name="nombreUnite" min="1" required
                                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                           placeholder="Ex: 10">
                                </div>
                            </div>
                            ...
                            <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-200">
                                ...
                                <textarea id="description" name="description" rows="4"
                                          ...
                                          placeholder="Décrivez l'immeuble, ses caractéristiques, son standing..."></textarea>
                            </div>
                        </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-200">
                                ...
                                <textarea id="equipements" name="equipements" rows="4"
                                          ...
                                          placeholder="Ex: Ascenseur, Parking, Gardien, Groupe électrogène, Climatisation..."></textarea>
                            </div>
                            ...
                            <div class="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-2xl p-6 border border-orange-200">
                                ...
                                <!-- Zone de drop -->
                                <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-orange-400 transition-colors duration-200" id="dropZone">
                                    <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between pt-8 border-t border-gray-200 mt-8">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <button type="submit" class="inline-flex items-center px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl">
                                <i class="fas fa-plus mr-2"></i>Créer l'immeuble
                            </button>
                        </div>
                    </div>
                </form>

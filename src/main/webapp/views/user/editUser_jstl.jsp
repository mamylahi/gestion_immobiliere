        ...
        <div class="max-w-4xl mx-auto">
                    ...
                    <div class="relative z-10">
                        ...
                        <nav class="mb-4">
                            <div class="flex items-center space-x-2 text-white text-opacity-80 text-sm">
                                ...
                                <span class="text-white">Modifier utilisateur</span>
                            </div>
                        </nav>
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                <h1 class="text-3xl font-bold mb-2">Modifier l'Utilisateur</h1>
                                <p class="text-white text-opacity-90">Mettez à jour les informations du compte utilisateur</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium mt-1
                            <c:choose>
                                <c:when test="${user.role == 'ADMIN'}">bg-red-100 text-red-800</c:when>
                                <c:when test="${user.role == 'PROPRIETAIRE'}">bg-blue-100 text-blue-800</c:when>
                                <c:when test="${user.role == 'LOCATAIRE'}">bg-green-100 text-green-800</c:when>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-gray-50 to-blue-50 px-8 py-6 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-gray-600 mt-1">Modifiez les champs nécessaires et cliquez sur "Mettre à jour"</p>
                        </div>
                        <div class="flex items-center space-x-2">
                            <div class="w-3 h-3 bg-orange-400 rounded-full"></div>
                            <span class="text-sm text-gray-600">Mode édition</span>
                        </div>
                    </div>
                </div>
                ...
                <form method="post" action="user" class="p-8" id="userForm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            <label for="motDePasse" class="block text-sm font-medium text-gray-700 flex items-center">
                                ...
                                <span class="ml-2 text-xs text-gray-500">(Laissez vide pour conserver l'actuel)</span>
                            </label>
                            <div class="relative">
                            ...
                            <div class="text-xs text-gray-500" id="passwordStrengthContainer" style="display: none;">
                        ...
                        <div class="space-y-2">
                            ...
                            <select id="role" name="role" required
                                ...
                                <option value="PROPRIETAIRE" ${user.role == 'PROPRIETAIRE' ? 'selected' : ''}>
                                    Propriétaire - Gestion des biens
                                </option>
                                <option value="LOCATAIRE" ${user.role == 'LOCATAIRE' ? 'selected' : ''}>
                                    Locataire - Accès limité
                                </option>
                            </select>
                            <div class="invalid-feedback text-red-500 text-sm hidden">
                                <i class="fas fa-exclamation-circle mr-1"></i>
                    ...
                    <div class="mt-8 bg-yellow-50 rounded-xl p-6 border border-yellow-200" id="roleWarning" style="display: none;">
                        <div class="flex items-start">
                            <i class="fas fa-exclamation-triangle text-yellow-600 mr-3 mt-1"></i>
                            <div>
                                <h3 class="font-semibold text-yellow-800 mb-2">Attention - Changement de rôle</h3>
                                <p class="text-yellow-700 text-sm">
                                    Le changement de rôle modifiera immédiatement les permissions de cet utilisateur.
                                    Assurez-vous que ce changement est intentionnel.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 flex items-center justify-between pt-6 border-t border-gray-200">
                        <div class="flex items-center text-sm text-gray-500">
                            ...
                            Dernière modification: <span class="font-medium ml-1">Aujourd'hui</span>
                        </div>
                        <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">Par l'administrateur</p>
                            </div>
                        </div>
                        <span class="text-xs text-gray-500">15 nov. 2024</span>
                    </div>
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">Par l'utilisateur</p>
                            </div>
                        </div>
                        <span class="text-xs text-gray-500">15 nov. 2024</span>
                    </div>
...
<script>
    ...
    function validateField(e) {
        ...
        if (field.type === 'password' && value && value.length > 0 && value.length < 8) {
